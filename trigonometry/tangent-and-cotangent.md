...
![IMG. 1](svg/tangent-and-cotangent-1.svg)
...
![IMG. 2](svg/tangent-and-cotangent-2.svg)
...
The identities satisfied by the tangent follow directly from its definition as the ratio of sine to cosine. Each of the relations below can be obtained by dividing the corresponding identities for sine and cosine, and together they govern the behavior of the tangent under the addition, subtraction, doubling, and halving of angles. The last two relations connect the tangent to the secant through the Pythagorean identity and to the cotangent through their reciprocal nature:
...
Since the cotangent is the reciprocal of the tangent, its identities mirror those above with the roles of numerator and denominator interchanged. The relations below express the cotangent of a sum, a difference, a doubled angle, and a halved angle, and the final identity links the cotangent to the cosecant through the Pythagorean relation:
...
![IMG. 4](svg/tangent-and-cotangent-4.svg)
...
![IMG. 5](svg/tangent-and-cotangent-5.svg)
...
> A detailed treatment of the [tangent function](../tangent-function/) and the [cotangent function](../cotangent-function/), including notable values, limits, derivatives, and integrals, is provided in their respective entries.
...
The half-angle formula for the tangent is the starting point of one of the most useful techniques in [integral](../definite-integrals/) calculus, the [Weierstrass substitution](../the-weierstrass-substitution/). The substitution is defined by:
