...
The crucial step is to add and subtract $\left(\dfrac{b}{2a}\right)^{2}$ inside the parentheses, a quantity chosen so that the three terms involving $x$ form a perfect square [trinomial](../trinomials/), one of the standard [notable products](../notable-products/):
...
![IMG. 1](svg/completing-the-square-1.svg)
