...
source: https://algebrica.org/notable-products/
...
In this way the expression is a difference of two squares, and the factorisation follows from the standard identity. The intermediate step is itself an instance of [completing the square](../completing-the-square/).
...
The following table summarizes some of the most important notable products and algebraic factorization identities:
