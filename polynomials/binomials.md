---
title: Binomials
source: https://algebrica.org/binomials/
...
A binomial refers to a [polynomial](../polynomials/) that contains exactly two non-zero [monomials](../monomials/). Its general form is expressed as $(a + b)$ or $(a - b)$.
...
The FOIL method applies exclusively to the multiplication of two binomials. For products involving polynomials with more than two terms, the general procedure of [multiplying polynomials](../multiplying-polynomials/) by repeated application of the distributive property must be used instead.
