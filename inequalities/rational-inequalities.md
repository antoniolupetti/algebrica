...
> The reciprocal rule and its operational use are particular cases of the more general phenomenon analysed in the entry on [loss and introduction of solutions](../loss-of-solutions-in-inequalities/). The reduction to canonical form is the systematic countermeasure and replaces the case analysis on the sign of the variable expression with a single sign chart on the numerator and the denominator.
