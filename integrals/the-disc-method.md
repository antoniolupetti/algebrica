...
A solid of revolution is the region of space swept out when a plane region turns around a fixed line, called the axis of revolution. If the region lies in the $xy$-plane and the axis is the $x$-axis, every point of the region traces a [circle](../circumference/) whose plane is perpendicular to the axis. The union of all these circles fills the solid.
